...
export interface ApiDisabilityCardDisabilityCard
  ...
  attributes: {
    ...
    issuingDate: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    EventType: Schema.Attribute.Enumeration<
      ['Concert', 'Exhibition', 'Theater', 'Info Session', 'Other events']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactData: Schema.Attribute.Component<
      'custom-components.contact-data',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    >;
    LocationOverview: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    openingHours: Schema.Attribute.Component<
      'custom-components.opening-hours',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<'custom-components.address', true>;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    format: Schema.Attribute.Enumeration<['digital', 'paper', 'QR code']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket.ticket'
    ...
    statusOfTheTicket: Schema.Attribute.Enumeration<
      ['available', 'sold out', 'reserved']
    > &
      Schema.Attribute.Required;
    ticketType: Schema.Attribute.Enumeration<
      ['Standard', 'Accessible', 'Companion', 'Volunteer']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
